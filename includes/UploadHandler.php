...
class UploadHandler {
	...
	function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		$this -> options = array('script_url' => $this -> get_full_url() . '/', 'upload_dir' => dirname($this -> get_server_var('SCRIPT_FILENAME')) . '/upload/image/' . $user . '/', 'upload_url' => $this -> get_full_url() . '/upload/image/' . $user . '/', 'user_dirs' => false, 'mkdir_mode' => 0755, 'param_name' => 'files',
		...
		'max_width' => 1920, 'max_height' => 1920, 'min_width' => 1, 'min_height' => 1,
		...
		'identify_bin' => 'identify', 'image_versions' => array(
		...
		'upload_dir' => dirname($this -> get_server_var('SCRIPT_FILENAME')) . '/upload/thumb/' . $user . '/', 'upload_url' => $this -> get_full_url() . '/upload/thumb/' . $user . '/',
