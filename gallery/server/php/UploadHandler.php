...
class UploadHandler {
	...
	function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		$this -> options = array('script_url' => $this -> get_full_url() . '/', 'upload_dir' => dirname($this -> get_server_var('SCRIPT_FILENAME')) . '/files/' . $user . '/', 'upload_url' => $this -> get_full_url() . '/files/' . $user . '/', 'user_dirs' => false, 'mkdir_mode' => 0755, 'param_name' => 'files',
		...
		'upload_dir' => dirname($this -> get_server_var('SCRIPT_FILENAME')) . '/thumb/' . $user . '/', 'upload_url' => $this -> get_full_url() . '/thumb/' . $user . '/',
